...
<div id="login-wrapper" class="png_bg">
  ...
  <div id="login-content">
    <form action="${applicationScope.path }/login/login.jap" method="post">
      <div class="notification information png_bg">
        <div></div>
        <div>注意：只有管理员才可以从这里登录，否则失败三次后系统会自动屏蔽您的IP！ </div>
        <div style="color:red;text-align:center"><s:fielderror /><s:actionerror /></div>
      </div>
      <p>
        <label>E-Mail</label>
      ...
      <p>
        <label>用户名</label>
        <input class="text-input" type="text" name="user" value="${user }"/>
      </p>
      <div class="clear"></div>
      <p>
        <label>密码</label>
        <input class="text-input" type="password"  name="passwd" value="${passwd }"/>
      </p>
      <div class="clear"></div>
